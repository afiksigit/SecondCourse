...
def main():
    ...
    background = Image.open("ex6p4.jpg")

    # Create a new image with the same size as the background image
    image = Image.new("RGB", background.size)
    ...
    # Draw lines for the first list of points
    draw.line(first, fill="blue", width=5)

    # Draw lines for the second list of points
    draw.line(second, fill="blue", width=5)

    # Save the image as "animal.png"
